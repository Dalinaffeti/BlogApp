...
function UserProfile({user, additionalData}) {
    ...
    return (
        <div className="userProfile pointer">
          <h1>User Profile</h1>
            <HomeOutlined style={{color: '#ffcc00'}} fontSize='large' onClick={handleHomeRoute} />
            {editOn? <CheckCircleIcon fontSize='large' style={{color: 'green'}} onClick={updateProfile} /> :<Edit className="pointer" onClick={editToggle} style={{color: 'blue'}} />}
           <TextField
                    variant="outlined"
                    required
                    ...
                    style={{border: editOn? '2px lightblue solid' :"none", color: 'white', boxShadow: editOn? ' 10px 10px 8px #888888' :"none", marginTop: "10px"}}
