 ...
 const handleHomeRoute=()=>{
    ...
    return (
        ...
        <div  className={classes.paper}>
            ...
            <Button  style={{backgroundColor:"black",color:"white", fontWeight:"bold"}} onClick={handleHomeRoute}>Home</Button>
            <h1 style={{color:"white", fontWeight:"bold", padding:"10px"}}>Create Poster</h1>
            <h3 style={{color:"white", fontWeight:"bold", padding:"5px"}}>Upload Poster Picture</h3>
              <div>
              <div class="image-upload">
  <label for="file-input">
  < AddCircle className="pointer"   style={{width:"50px", height:"50px", color:"green" }}/>
  </label>
  ...
  <div>
    <label>Description</label>
           ...
           <IconButton >
           <input style={{backgroundColor:"green"}} className={classes.submit} type="submit" value="Add Poster" />
