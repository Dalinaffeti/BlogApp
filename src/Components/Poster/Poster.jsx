...
function Poster(props, {isLoading}) {
  ...
  const PostOptions = () => {
    return (
      <div>
        <HighlightOffIcon className="pointer"
          style={{ color: "red" }}
          onClick={() => {
            setIsOpen(false);
          }}
        />
        <p  className="pointerOptions" style={{padding: '5px'}} onClick={editPost}>edit</p>
        <p  className="pointerOptions" style={{padding: '5px'}} onClick={deleteDoc}>delete</p>
      </div>
    );
  };
  ...
  return editOpen ? (
    ...
    <div className="poster box">
      ...
      >
        ...
        >
          <img src={imageUrl ? imageUrl : ''} alt="loading.." width="270" height="270" />
        </div>
        <div
